...
//timeline api
export const SELECT_TIMELINE = `select t.*, u.user_image, u.user_name, u.unique_name from tweets t LEFT JOIN users u on u.user_id = t.user_id LEFT JOIN follows f on f.following_id = u.user_id AND f.user_id = ? WHERE f.user_id = ? OR u.user_id = ?;`;
